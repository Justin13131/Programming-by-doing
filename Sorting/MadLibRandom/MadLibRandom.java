//Sorting MadLibRandom 40pts Justin Hsu
...
public class MadLibRandom
{
	public static void main(String[] args)
	{
		...
		int adv  = 0 + (int)(Math.random()* adverbs.length    ); // past-tense verb 1
		...
		System.out.printf("\"Don't be such a(n) " + noun1 + "! We're going in. I think it looks \n" + advs + noun2 );
		System.out.printf("un-haunted!\" said %s.\n\n", female );

		System.out.printf(female + "was so scared that he could not open his eyes. He felt his %s\n", male, bodypart );
