...
public class HangManGame {
	...
	//public static String[] words = {"kangaroo","cheerleading","hairbrush", "overwhelm", "apartment", "caterpillar"};
	...
	private static String word = words.get((int) (Math.random() * words.length));
